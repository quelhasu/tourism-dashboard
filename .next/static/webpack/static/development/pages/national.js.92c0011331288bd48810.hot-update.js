          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 3;
                return _this.axiosProgress("http://localhost:3000/BM/national/".concat(_this.state.selectedYear, "/?countries=").concat(newValue.map(function (el) {
                  return el.value;
                }).join()));
...
//# sourceMappingURL=national.js.92c0011331288bd48810.hot-update.js.map