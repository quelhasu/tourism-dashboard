          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                console.log("http://localhost:3000/BM/national/".concat(_this.state.selectedYear, "/?countries=").concat(newValue.map(function (el) {
                  return el.value;
                }).join()));
...
//# sourceMappingURL=national.js.7e3dbaadef7fa1d17088.hot-update.js.map