  ...
  function DiffTable(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this), "createTable", function () {
      ...
      for (var i = 0; i < length; i++) {
        console.log('%c' + _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(_this.props.evolution)[i].value, 'color: '); // if (i % Math.ceil(length/2) == 0 && i != 0) {
        //   table.push(
        //     <tr>
        //       <th scope="col"></th>
        //       {children}
        ...
        // children.push(<th key={`head-${Object.keys(this.props.evolution)[i].value}`}>{Object.keys(this.props.evolution)[i].value}</th>)
      }
...
//# sourceMappingURL=national.js.47ff9526e10da7c5a8f0.hot-update.js.map