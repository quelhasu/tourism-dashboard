...
function (_React$Component) {
  ...
  function National(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_9__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_7__["default"])(_this), "handleAgesRange", function (newValue, actionMeta) {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.next = 3;
                return _this.axiosProgress("http://localhost:3000/BM/national/".concat(_this.state.selectedYear.value, "/?\n      countries=").concat(_this.selected.topCountries.map(function (el) {
                  return el.value;
                }).join(), "&\n      regions=").concat(_this.selected.topRegions.map(function (el) {
                  return el.value;
                }).join()).replace(/ /g, "_"));
...
//# sourceMappingURL=national.js.9d42f0e14c79a5736c59.hot-update.js.map