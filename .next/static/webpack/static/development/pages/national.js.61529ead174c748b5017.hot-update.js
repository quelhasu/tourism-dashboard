        ...
        return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                console.log(newValue.map(function (el) {
                  return el.value;
                }).join()); // const res = await this.axiosProgress(`http://localhost:3000/BM/national/${this.state.selectedYear}/?countries=${newValue.map(el=> el.value).join()}`)
...
//# sourceMappingURL=national.js.61529ead174c748b5017.hot-update.js.map