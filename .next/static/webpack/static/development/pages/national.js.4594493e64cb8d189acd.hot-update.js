          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 5:
                ...
                }); // this.setState({selected: this.state.info});
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                _this.setState(function (prevState) {
                  return {
                    selected: Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_1__["default"])({}, prevState.info, {
                      topCountries: newValue
                    })
                  };
                });
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.next = 4;
                return _this.axiosProgress("http://localhost:3000/BM/national/".concat(_this.state.selectedYear.value, "/?      countries=").concat(_this.state.selected.topCountries.map(function (el) {
                  return el.value;
                }).join(), "&      regions=").concat(_this.state.selected.topRegions.map(function (el) {
                  return el.value;
                }).join()));
...
//# sourceMappingURL=national.js.4594493e64cb8d189acd.hot-update.js.map