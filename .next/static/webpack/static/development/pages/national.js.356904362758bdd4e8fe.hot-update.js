...
function chartData(props) {
  data.datasets = _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(props.evolution).map(function (key) {
    console.log(props.evolution[key][props.var].months.low);
    return {
      label: key,
      ...
      data: props.evolution[key][props.var].months.low,
      fill: false
    };
  });
}
...
//# sourceMappingURL=national.js.356904362758bdd4e8fe.hot-update.js.map