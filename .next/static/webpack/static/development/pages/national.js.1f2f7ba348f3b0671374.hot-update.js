  ...
  function DiffTable(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this), "createTable", function () {
      ...
      for (var i = 0; i < length; i++) {
        // console.log('%c' + Object.keys(this.props.evolution)[i], 'color: ');
        if (i % Math.ceil(length / 2) == 0 && i != 0) {
          ...
          console.log("children before reset", _children);
          var _children = [];
        }

        console.log('push to child...');
        children.push(react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement("th", {
          key: "head-".concat(_babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(_this.props.evolution)[i])
        }, _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(_this.props.evolution)[i]));
      }
...
//# sourceMappingURL=national.js.1f2f7ba348f3b0671374.hot-update.js.map