...
function (_React$Component) {
  ...
  function GoingChart(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this), "chartData", function () {
      _this.data.labels = _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(_this.props.evolution).map(function (key) {
        return key;
      });
      _this.data.datasets[0].data = _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(_this.props.evolution).map(function (key) {
        return _this.props.evolution[key][_this.props.year]['Ingoing'];
      });
      _this.data.datasets[1].data = _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(_this.props.evolution).map(function (key) {
        return _this.props.evolution[key][_this.props.year]['Outgoing'];
      });
...
//# sourceMappingURL=national.js.89d3d6a1f5c380c6fb0c.hot-update.js.map