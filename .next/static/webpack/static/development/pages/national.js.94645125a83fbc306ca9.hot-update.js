        ...
        return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return _this.axiosProgress("http://localhost:3000/BM/national/".concat(_this.state.selectedYear.value, "/?countries=").concat(newValue.map(function (el) {
                  return el.value;
                }).join()));
              ...
              case 2:
                ...
                _this.setState({
                  data: res.data
                }); // console.log(`http://localhost:3000/BM/national/${this.state.selectedYear.value}/?countries=${newValue.map(el=> el.value).join()}`);
...
//# sourceMappingURL=national.js.94645125a83fbc306ca9.hot-update.js.map