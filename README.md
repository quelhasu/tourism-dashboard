...
![GitHub last commit](https://img.shields.io/github/last-commit/quelhasu/tourism-dashboard.svg?logo=github)
...
This project is a micro-service of the **Neo4Tourism framework** including the [REST API](https://github.com/quelhasu/tourism-api), the Neo4J database and the [administrator dashboard](https://github.com/quelhasu/tourism-admin).
